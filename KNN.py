...
for train_index, test_index in skf.split(X, y):
    ...
    def rf(n_neighbors, leaf_size):
        rf = KNeighborsClassifier(n_neighbors=int(n_neighbors), leaf_size=int(leaf_size))
    ...
    best_model=KNeighborsClassifier(n_neighbors=int(params['n_neighbors']), leaf_size=int(params['leaf_size'])
                               )
